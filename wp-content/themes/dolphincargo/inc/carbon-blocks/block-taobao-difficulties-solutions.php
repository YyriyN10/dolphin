<?php
	...
	add_action( 'carbon_fields_register_fields', 'dolphincargo_block_taobao_difficulties_solutions' );

	function dolphincargo_block_taobao_difficulties_solutions(){
		Block::make( __( 'Difficulties and solutions' ) )
		     ->add_fields( array(
			     Field::make_text('dolphincargo_difficulties_title', 'Заголовок переліку труднощів'),
			     Field::make_complex('dolphincargo_difficulties_list', 'Перелік труднощів')
			          ->add_fields( array(
				          Field::make_text('text', 'Текст трудності')
			          )),
			     Field::make_text('dolphincargo_solutions_title', 'Заголовок переліку рішень'),
			     Field::make_complex('dolphincargo_solutions_list', 'Перелік рішень')
			          ->add_fields( array(
				          Field::make_text('text', 'Текст рішення')
			          )),
			     Field::make_text('dolphincargo_marque_text', 'Текст бігучого рядку'),
		     ...
		     ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
			     ...
			     <!-- Переваги -->
			     <?php if ( $fields['dolphincargo_difficulties_list'] && $fields['dolphincargo_solutions_list'] && $fields['dolphincargo_difficulties_title'] && $fields['dolphincargo_solutions_title']):?>
				     <section class="taobao-difficulties-solutions indent-top-small indent-bottom-small animation-tracking" >
                 ...
                 <g style="mix-blend-mode:luminosity" opacity="0.2">
                   ...
                   <path d="M127.802 480.935C127.802 371.527 200.803 279.017 300.664 249.552C301.098 249.119 301.314 248.686 301.531 248.252C308.246 240.453 319.294 221.604 326.225 209.472C191.055 210.555 81.6625 320.397 81.6625 456.02C81.6625 563.262 150.114 654.255 245.426 688.269C175.025 646.023 127.802 568.895 127.802 480.935Z" fill="#464646"/>
					     ...
					     <div class="container-fluid">
						     <div class="row">
							     <div class="item-list-wrapper col-md-6 first-up">
								     <div class="inner">
									     <h3 class="name">
                         <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M6 18.5L12 12.5M12 12.5L6 6.5M12 12.5L18 18.5M12 12.5L18 6.5" stroke="#067FEF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                         </svg>
                         <?php echo $fields['dolphincargo_difficulties_title'];?>
									     </h3>
									     <ul class="list-wrapper">
										     <?php foreach( $fields['dolphincargo_difficulties_list'] as $item ):?>
											     <li class="item">
                             ...
                             <span><?php echo $item['text'];?></span>
							     ...
							     <div class="item-list-wrapper col-md-6 second-up">
								     <div class="inner">
									     <h3 class="name">
                         <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M6 9.5L12 15.5L18 9.5" stroke="#067FEF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                         </svg>

                         <?php echo $fields['dolphincargo_solutions_title'];?>
									     </h3>
									     <ul class="list-wrapper">
										     <?php foreach( $fields['dolphincargo_solutions_list'] as $item ):?>
                           <li class="item">
                             <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                               <path d="M4.92893 12H12M12 12V4.92896M12 12V19.0711M12 12H19.0711" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                             </svg>
												     <span><?php echo $item['text'];?></span>
											     </li>
										     <?php endforeach;?>
					     ...
					     <?php if( !empty($fields['dolphincargo_marque_text']) ):?>
                 <div class="marque-wrapper">
                   <div class="marque-list marquee-move">
								     <?php
									     ...
									     for ($mi = 0; $mi < 10; $mi ++):?>
                         <p class="marque-item"><?php echo $fields['dolphincargo_marque_text'];?></p>
