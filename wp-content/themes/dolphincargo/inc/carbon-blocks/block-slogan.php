		     ...
		     ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
			     ...
			     <?php if ( $fields['dolphincargo_block_slogan_title'] && $fields['dolphincargo_block_slogan_text'] && $fields['dolphincargo_block_slogan_marquee'] ):?>
				     <section class="block-slogan animation-tracking indent-top-big indent-bottom-small" >
					     ...
					     <div class="light"><img src="<?php echo THEME_PATH;?>/assets/img/airplan-call-to-light.png" alt="<?php the_title();?>"></div>
					     ...
					     <div class="marquee-wrapper">
						     <p class="run-row"><?php echo $fields['dolphincargo_block_slogan_marquee'];?></p>
					     </div>
				     </section>
			     <?php endif;?>
