<?php
	...
	add_action( 'carbon_fields_register_fields', 'dolphincargo_block_price_why_us' );

	function dolphincargo_block_price_why_us(){
		Block::make( __( 'Why choose us' ) )
		     ->add_fields( array(
			     Field::make_text('dolphincargo_block_problem_title', 'Заголовок блоку'),
			     Field::make_complex('dolphincargo_block_problem_list', 'Перелік переваг')
			          ->add_fields(array(
				          Field::make_text('name', 'Назва переваги'),
				          Field::make_complex('reason_list', 'Складові переваги')
				               ->add_fields(array(
		     ...
		     ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
			     ...
			     <?php if( !empty( $fields['dolphincargo_block_problem_title'] ) && !empty( $fields['dolphincargo_block_problem_list']) ):?>
				     ...
				     <section class="block-price-why-us indent-top-small indent-bottom-small animation-tracking" >
                 ...
                 <div class="row">
							     ...
							     <ul class="problem-list col-12 second-up">
								     <?php foreach( $fields['dolphincargo_block_problem_list'] as $item ):?>
									     <li class="problem">
