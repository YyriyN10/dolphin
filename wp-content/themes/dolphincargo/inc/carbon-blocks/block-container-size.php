			     ...
			     Field::make_complex('dolphincargo_list', 'Формати контейнерів')
			          ->add_fields( array(
				            Field::make_text('name', 'Назва формату'),
					          ...
					          Field::make_text('height', 'Висота'),
					          Field::make_text('volume', 'Об’єм'),
				     ...
				     <section class="container-sizing indent-top-small indent-bottom-small animation-tracking">
					     <div class="container-fluid">
                             ...
                             <?php endif;?>
                               ...
                               <li class="item">
													     <span class="label">
														     <?php echo esc_html( pll__( 'Висота' ) ); ?>
													     </span>
                                 <span class="data"><?php echo $item['height'];?></span>
                               </li>
												     <?php endif;?>
                               ...
                               <li class="item">
													     <span class="label">
														     <?php echo esc_html( pll__( 'Об’єм' ) ); ?>
													     </span>
                                 <span class="data"><?php echo $item['volume'];?></span>
                               </li>
												     <?php endif;?>

												     <?php if( !empty($item['empty_weight']) ):?>
                               <li class="item">
													     <span class="label">
                                 ...
                                 <span class="data"><?php echo $item['empty_weight'];?></span>
												     ...
												     <?php if( !empty($item['load_capacity']) ):?>
                               <li class="item">
													     <span class="label">
