<?php
	...
	add_action( 'carbon_fields_register_fields', 'dolphincargo_how_we_page' );

	function dolphincargo_how_we_page() {
		Container::make( 'post_meta', 'Головна')
		         ->where( function( $homeFields ) {
			         $homeFields->where( 'post_type', '=', 'page' );
			         $homeFields->where( 'post_template', '=', 'template-how-we-work.php' );
		         } )
