			      ...
			      ?>
			         ...
			         <section class="block-faq">
			           ...
			           <div class="container-fluid">
			             <div class="row">
			               <h2 class="block-title col-12 text-center"><?php echo $fields['dolphincargo_block_faq_title'];?></h2>
			             </div>
			             <div class="row">
				             <div class="accordion col-12" id="accordion-faq">
					             ...
					             <?php foreach( $fields['dolphincargo_block_faq_list'] as $index => $item ):?>
						             <div class="card">
							             <div class="card-header">
								             <a class="card-link" data-toggle="collapse" href="#faq<?php echo $index;?>">
                               ...
                               <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M18 9.5L12 15.5L6 9.5" stroke="#FBFBFB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
							             ...
							             <div id="faq<?php echo $index;?>" class="collapse show" data-parent="#accordion-faq">
								             <div class="card-body">
