<?php
	...
	add_action( 'carbon_fields_register_fields', 'dolphincargo_container_call_to_action' );

	function dolphincargo_container_call_to_action(){
		Block::make( __( 'Container call to action' ) )
		     ->add_fields( array(
		     ...
		     ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
			     ...
			     if( !empty($fields['dolphincargo_title']) && !empty($fields['dolphincargo_image']) ):?>
				     <!-- Заклик до дії -->
				     <section class="container-call-to-acton indent-top-small indent-bottom-small animation-tracking">
