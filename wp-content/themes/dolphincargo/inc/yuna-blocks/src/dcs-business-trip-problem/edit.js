...
export default function Edit({ attributes, setAttributes }) {
	...
	const { anchorId, bloсkZindex, topRadius, backgroundType, blockTitle, blockSubtitle, topIndent, bottomIndent, bgImageUrl, bgImageId } = attributes;
	...
	//Inner block
	const cardTemplate = [
		['dcs/business-trip-problem-inner',{}]
	];
