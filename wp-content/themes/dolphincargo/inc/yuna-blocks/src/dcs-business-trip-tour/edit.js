...
export default function Edit({ attributes, setAttributes }) {
	...
	const { anchorId, bloсkZindex, topRadius, backgroundType, blockTitle, topIndent, bottomIndent, bgImageUrl, bgImageId, blockText } = attributes;
				...
				<div className="container">
					<div className="row">
						{bgImageUrl ? (
							...
							<p>Зображення логотпу не обрано</p>
						)}
						<MediaUploadCheck>
							<MediaUpload
								...
								render={({ open }) => (
									<Button onClick={open} variant="primary">
										{bgImageUrl ? 'Змінити зображення логотпу' : 'Завантажити зображення логотпу'}
									</Button>
								)}
							/>
						</MediaUploadCheck>
