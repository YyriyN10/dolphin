...
"use strict";
/*!***********************************************!*\
  !*** ./src/dcs-business-trip-problem/view.js ***!
  \***********************************************/
...
if (window.innerWidth > 1024) {
  function initHorizontalScrollBlock(block) {
    ...
    const tween = gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(track, {
      x: () => -getScrollDistance(),
      ease: 'none',
      scrollTrigger: {
        trigger: block,
    ...
    const onResize = () => {
      gsap_dist_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.refresh();
    };
  ...
  document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.wp-block-dcs-business-trip-problem').forEach(block => {
